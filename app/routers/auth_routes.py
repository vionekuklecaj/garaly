...
from app.schemas import AccountUpdate, UserLogin, UserOut, UserRegister
...
async def update_account(
    ...
    if data.current_password is not None and not verify_password(data.current_password, user.password_hash):
